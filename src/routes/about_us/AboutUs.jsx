    ...
    const components = [
        ...
        },
        {
            ...
            items: [
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Website Design: </span><br />
                ...
                <>
                    <span  style={{ fontWeight: 'bold', fontSize: '2rem' }}>Script Writing: </span><br />
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Digital Marketing: </span><br />
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Animation: </span><br />
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Character Design: </span><br />
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Graphic Design: </span><br />
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Motion Graphic: </span><br />
                ...
                <>
                    <span style={{ fontWeight: 'bold', fontSize: '2rem' }}>Professional Photography: </span><br />
